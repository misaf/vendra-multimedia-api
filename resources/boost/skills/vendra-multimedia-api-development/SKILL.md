...
Treat `app-modules/vendra-multimedia-api` as the JSON:API layer for `misaf/vendra-multimedia`.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-multimedia-api test` and `composer --working-dir=app-modules/vendra-multimedia-api analyse`.

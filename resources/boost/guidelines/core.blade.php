...
- Keep the module tenant-agnostic: it must build and run with or without a tenant provider. Inherit tenancy through the `Misaf\VendraMultimedia` domain models and never reference a concrete provider such as `Misaf\VendraTenant` in servers, schemas, queries, routes, or tests.
